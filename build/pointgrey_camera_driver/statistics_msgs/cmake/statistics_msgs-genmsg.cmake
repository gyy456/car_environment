...
set(MSG_I_FLAGS "-Istatistics_msgs:/home/gyy/Downloads/car/src/pointgrey_camera_driver/statistics_msgs/msg")
...
get_filename_component(_filename "/home/gyy/Downloads/car/src/pointgrey_camera_driver/statistics_msgs/msg/Stats1D.msg" NAME_WE)
add_custom_target(_statistics_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "statistics_msgs" "/home/gyy/Downloads/car/src/pointgrey_camera_driver/statistics_msgs/msg/Stats1D.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/statistics_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/statistics_msgs\")")
  # install generated code
  install(
