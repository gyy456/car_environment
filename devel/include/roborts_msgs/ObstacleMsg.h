// Generated by gencpp from file roborts_msgs/ObstacleMsg.msg
// DO NOT EDIT!


#ifndef ROBORTS_MSGS_MESSAGE_OBSTACLEMSG_H
#define ROBORTS_MSGS_MESSAGE_OBSTACLEMSG_H
...
struct ObstacleMsg_
{
  ...
  typedef boost::shared_ptr< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> const> ConstPtr;

}; // struct ObstacleMsg_

typedef ::roborts_msgs::ObstacleMsg_<std::allocator<void> > ObstacleMsg;

typedef boost::shared_ptr< ::roborts_msgs::ObstacleMsg > ObstacleMsgPtr;
typedef boost::shared_ptr< ::roborts_msgs::ObstacleMsg const> ObstacleMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::roborts_msgs::ObstacleMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::roborts_msgs::ObstacleMsg_<ContainerAllocator1> & lhs, const ::roborts_msgs::ObstacleMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::roborts_msgs::ObstacleMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa537b0b7fce70da7ULL;
  static const uint64_t static_value2 = 0xb78c2df042f56aa2ULL;
};

template<class ContainerAllocator>
struct DataType< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::roborts_msgs::ObstacleMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::roborts_msgs::ObstacleMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ROBORTS_MSGS_MESSAGE_OBSTACLEMSG_H
