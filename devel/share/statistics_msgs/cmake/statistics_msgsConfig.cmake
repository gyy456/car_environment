...
if("TRUE" STREQUAL "TRUE")
  set(statistics_msgs_SOURCE_PREFIX /home/gyy/Downloads/car/src/pointgrey_camera_driver/statistics_msgs)
  set(statistics_msgs_DEVEL_PREFIX /home/gyy/Downloads/car/devel)
  ...
  set(statistics_msgs_INSTALL_PREFIX /home/gyy/Downloads/car/install)
...
if(NOT "/home/gyy/Downloads/car/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'statistics_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gyy/Downloads/car/src/pointgrey_camera_driver/statistics_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT statistics_msgs_NUM_DUMMY_TARGETS)
      set(statistics_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::statistics_msgs::wrapped-linker-option${statistics_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR statistics_msgs_NUM_DUMMY_TARGETS "${statistics_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::statistics_msgs::wrapped-linker-option${statistics_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND statistics_msgs_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(statistics_msgs_EXPORTED_TARGETS ${${statistics_msgs_dep}_EXPORTED_TARGETS})
endforeach()
