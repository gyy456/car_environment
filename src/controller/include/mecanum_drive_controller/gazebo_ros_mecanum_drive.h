...
#ifndef MECANUM_DRIVE_PLUGIN_HH
#define MECANUM_DRIVE_PLUGIN_HH
...
namespace gazebo {
  ...
  class GazeboRosMecanumDrive : public ModelPlugin {
    ...
    public:
      ...
      ~GazeboRosMecanumDrive();
      void Load(physics::ModelPtr parent, sdf::ElementPtr sdf); //插件初始化
    ...
    private:
      ...
      physics::ModelPtr parent_; //指向仿真模型的指针
      event::ConnectionPtr update_connection_; //仿真循环事件的连接指针
