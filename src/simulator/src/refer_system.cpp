...
#include "simulator/ReferSystemInfo.h"
...
public:
    ...
    nh_(nodehandle)    
    {
        ...
        state_pub = nh_.advertise<simulator::ReferSystemInfo>("refer_system_info", 1, true);
    ...
    bool startGame(simulator::GameState::Request &req,
                   simulator::GameState::Response &res){
...
private:
    ...
    simulator::ReferSystemInfo   refer_system_msg;
